                            ...
                            <div class="page-title">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <h3>
                                            Edit Page :
                                            <a href="<?= $base_url; ?>/page/add.php" class="btn btn-primary">
                                                <!-- plus icon -->
                                                        ...
                                                        <div class="col-12 mb-1">
                                                            ...
                                                            <div class="mt-2 py-1">
                                                                ...
                                                                <div class="form-group" id="postLinkBloc">
                                                                    ...
                                                                    <a href="#" id="postLinkShow" class="vrm-link vrm-link-md"><?= $base_url; ?>/sample-page-post</a>

                                                                    <!-- Edit Area -->
                                                                    <label id="postLinkMain" class="vrm-link-blunt vrm-link-sm d-none"><?= $base_url; ?>/</label>
